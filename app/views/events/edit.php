...
<div class="row justify-content-center">
    <div class="col-lg-7">
        ...
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= url('/events') ?>">Explore</a></li><li class="breadcrumb-item"><a href="<?= url('/events/' . $event['id']) ?>"><?= e($event['title']) ?></a></li><li class="breadcrumb-item active">Edit</li></ol>
        </nav>

        <div class="card auth-card">
            <div class="card-body p-4">
                <h1 class="h4 fw-bold mb-1">Edit Event</h1>
                <p class="small mb-4" style="color:var(--muted);">Update the details below.</p>
                ...
                <form method="POST" action="<?= url('/events/' . $event['id'] . '/update') ?>" novalidate>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" id="event_date" name="event_date"
                                   value="<?= e(date('Y-m-d\TH:i', strtotime($event['event_date']))) ?>"
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?= url('/events/' . $event['id']) ?>" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
