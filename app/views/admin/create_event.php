    ...
    <div class="col-lg-7">
        ...
        <div class="card auth-card">
            <div class="card-body p-4">
                <h1 class="h4 fw-bold mb-1">Create Event</h1>
                <p class="small mb-4" style="color:var(--muted);">Create an event on behalf of any organiser.</p>
                ...
                <form method="POST" action="<?= url('/admin/events/store') ?>" novalidate>
                    <input type="hidden" name="csrf_token" value="<?= e($csrf) ?>">

                    <div class="mb-3">
                        <label for="title" class="form-label">Event title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="title" name="title"
                               value="<?= e($old['title'] ?? '') ?>" minlength="3" maxlength="100" required>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="sport_type_id" name="sport_type_id" required>
                                ...
                                <option value="<?= e($st['id']) ?>" <?= ($old['sport_type_id'] ?? '') == $st['id'] ? 'selected' : '' ?>>
                                    <?= e($st['icon']) ?> <?= e($st['name']) ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="skill_level" name="skill_level">
                                ...
                                <option value="intermediate" <?= ($old['skill_level'] ?? 'intermediate') === 'intermediate' ? 'selected' : '' ?>>🟡 Intermediate</option>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="max_participants" name="max_participants"
                                   value="<?= e($old['max_participants'] ?? '') ?>" min="2" max="1000" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="location" name="location"
                               value="<?= e($old['location'] ?? '') ?>" maxlength="255" required>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="description" name="description" rows="4" minlength="10" required><?= e($old['description'] ?? '') ?></textarea>
                    </div>
